...
export class BibleBookRepository extends BaseRepository<BibleBook, CreateBibleBookDto, UpdateBibleBookDto> {
    ...
    protected mapRowToEntity(row: any): BibleBook {
        return {
            ...
            ChapterDisplayTitleJapanese: row.ChapterDisplayTitleJapanese,
            ChapterDisplayTitleGerman: row.ChapterDisplayTitleGerman,
    ...
    protected getCreateSql(bibleBook: CreateBibleBookDto): { sql: string; params: any[] } {
        ...
        return {
            sql: `INSERT INTO BibleBook (
                    ...
                    ChapterDisplayTitle, ChapterDisplayTitleGerman, ChapterDisplayTitleJapanese, ChapterDisplayTitleRich, PublicationId, 
            ...
            params: [
                ...
                bibleBook.ChapterDisplayTitleGerman ?? null,
                bibleBook.ChapterDisplayTitleJapanese ?? null,
    ...
    protected getUpdateSql(bibleBook: UpdateBibleBookDto): { sql: string; params: any[] } {
        ...
        return {
            sql: `UPDATE BibleBook SET 
                    ...
                    ChapterDisplayTitleGerman = COALESCE(?, ChapterDisplayTitleGerman),
                    ChapterDisplayTitleJapanese = COALESCE(?, ChapterDisplayTitleJapanese),
            ...
            params: [
                ...
                bibleBook.ChapterDisplayTitleGerman,
                bibleBook.ChapterDisplayTitleJapanese,
